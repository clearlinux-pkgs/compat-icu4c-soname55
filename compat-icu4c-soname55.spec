...
License  : MIT
Requires: compat-icu4c-soname55-bin
Requires: compat-icu4c-soname55-lib
Requires: compat-icu4c-soname55-data
Requires: compat-icu4c-soname55-doc
...
%package bin
Summary: bin components for the compat-icu4c-soname55 package.
Group: Binaries
Requires: compat-icu4c-soname55-data

%description bin
bin components for the compat-icu4c-soname55 package.


%package data
Summary: data components for the compat-icu4c-soname55 package.
Group: Data

%description data
data components for the compat-icu4c-soname55 package.


%package dev
Summary: dev components for the compat-icu4c-soname55 package.
Group: Development
Requires: compat-icu4c-soname55-lib
Requires: compat-icu4c-soname55-bin
Requires: compat-icu4c-soname55-data
Provides: compat-icu4c-soname55-devel

%description dev
dev components for the compat-icu4c-soname55 package.


%package dev32
Summary: dev32 components for the compat-icu4c-soname55 package.
Group: Default
Requires: compat-icu4c-soname55-lib32
Requires: compat-icu4c-soname55-bin
Requires: compat-icu4c-soname55-data
Requires: compat-icu4c-soname55-dev

%description dev32
dev32 components for the compat-icu4c-soname55 package.


%package doc
Summary: doc components for the compat-icu4c-soname55 package.
Group: Documentation

%description doc
doc components for the compat-icu4c-soname55 package.


%package lib
Summary: lib components for the compat-icu4c-soname55 package.
Group: Libraries
Requires: compat-icu4c-soname55-data

%description lib
lib components for the compat-icu4c-soname55 package.


%package lib32
Summary: lib32 components for the compat-icu4c-soname55 package.
Group: Default
Requires: compat-icu4c-soname55-data

%description lib32
lib32 components for the compat-icu4c-soname55 package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1522776446
pushd source
...
%files data
%defattr(-,root,root,-)
%exclude /usr/share/icu/55.1/config/mh-linux
%exclude /usr/share/icu/55.1/install-sh
%exclude /usr/share/icu/55.1/license.html
%exclude /usr/share/icu/55.1/mkinstalldirs

%files dev
%defattr(-,root,root,-)
%exclude /usr/include/layout/LEFontInstance.h
%exclude /usr/include/layout/LEGlyphFilter.h
%exclude /usr/include/layout/LEGlyphStorage.h
%exclude /usr/include/layout/LEInsertionList.h
%exclude /usr/include/layout/LELanguages.h
%exclude /usr/include/layout/LEScripts.h
%exclude /usr/include/layout/LESwaps.h
%exclude /usr/include/layout/LETableReference.h
%exclude /usr/include/layout/LETypes.h
%exclude /usr/include/layout/LayoutEngine.h
%exclude /usr/include/layout/ParagraphLayout.h
%exclude /usr/include/layout/RunArrays.h
%exclude /usr/include/layout/loengine.h
%exclude /usr/include/layout/playout.h
%exclude /usr/include/layout/plruns.h
...
%exclude /usr/lib64/libicule.so
%exclude /usr/lib64/libiculx.so
...
%exclude /usr/lib64/pkgconfig/icu-le.pc
%exclude /usr/lib64/pkgconfig/icu-lx.pc
...
%exclude /usr/lib32/libicule.so
%exclude /usr/lib32/libiculx.so
...
%exclude /usr/lib32/pkgconfig/32icu-le.pc
%exclude /usr/lib32/pkgconfig/32icu-lx.pc
%exclude /usr/lib32/pkgconfig/32icu-uc.pc
%exclude /usr/lib32/pkgconfig/icu-i18n.pc
%exclude /usr/lib32/pkgconfig/icu-io.pc
%exclude /usr/lib32/pkgconfig/icu-le.pc
%exclude /usr/lib32/pkgconfig/icu-lx.pc
